...
Route::get('/expense_report/{id}/confirmSendMail','ExpenseReportController@confirmSendMail');
...
Route::post('/expense_report/{expense_report}/expenses','ExpenseController@store');
